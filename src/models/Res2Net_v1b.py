# This code is from https://github.com/DengPingFan/PraNet/blob/master/lib/Res2Net_v1b.py
import math
...
class Res2Net(nn.Module):
    def __init__(
        self, block, layers, baseWidth=26, scale=4, num_classes=1000, in_channel=3
    ):
        self.inplanes = 64
...
def res2net50_v1b(pretrained=False, in_channel=3, **kwargs):
